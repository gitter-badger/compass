...
var PageTransitions = (function () {
	...
	function Animate($pageTrigger) {
		...
		if (!($pageTrigger.attr('data-animation'))) {
			alert("Transition.javascripts : Invalid attribute configuration. \n\n 'data-animation' attribute not found");
			return false;
		}
		...
		if (selectedAnimNumber > 67) {
			alert("Transition.javascripts : Invalid 'data-animation' attribute configuration. Animation number should not be greater than 67");
			return false;
		}
		...
		if (!(pagesCount < gotoPage)) {
			...
			alert("Transition.javascripts : Invalid 'data-goto' attribute configuration.");
		}
